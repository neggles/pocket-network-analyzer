                        ...
                        <form class="form" id="speedTestForm" autocomplete="off">
                            ...
                            <p>Advanced Options</p>
                             <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="pspeed-speedtest-server" id="pspeed-speedtest-server" placeholder="speedtest.test.com" autocomplete="off">
                             ...
                             <div class="form-group">
                                ...
                                <p class="help-block">Use this text field to identify a custom speed test port (Not Mandatory) <br> <small>Make sure you know that this port is running or it will result in an error.</small></p>
                            </div>
                            <div class="row">
                            <div class="col-xs-6">
                             <div class="form-group">
                        ...
                        <?php endif; ?>
                            ...
                            <div id="networkNameDiv" style="display:none;">
                                <div class="form-group">
                                    ...
                                    <option id="defaultWifi" value="empty">Populating Networks - please wait</option>
                                    <?php if (isset($settings->location)) : ?>
                                        <?php if (!empty($settings->location->default_network) && $settings->location->default_network !== '{}') :?>
...
function clearNotifications(){
    $('div#speedTestAlerts div#infoAlerts').text("").hide();
    $('div#speedTestAlerts div#warningAlerts').text("").hide();
    $('div#speedTestAlerts div#dangerAlerts').text("").hide();
    $('div#speedTestAlerts div#successAlerts').text("").hide();
}
    ...
    Example:
{
  ...
  "port": 8444
    ...
    /* End rmr speedtest channels */
        ...
        speedtestNotificationsChannel.bind('host', function(notification) {
            var message = notification.message;
            if(message !== "") {
                $("p#host").text(message);
...
<?php endif; ?>
        ...
        $(document).on('change', 'select#networkName', function() {
            ...
            if (enc == "none" || typeof enc === "undefined" || enc == "off") {
                ...
                //$('input#passphrase').parent().parent().remove();
                $('button#runSpeedTest').removeAttr('disabled');
        ...
        /*$(document).on('click', 'button#speedTestSubmit', function(e) {
            e.preventDefault();
        ...
        $(document).on('click', '#runSpeedTest', function(e) {
            ...
            var connection = $('form#speedTestForm select#interface').val();
            $('#speedTestConfirmWrapper').hide();
            processAlerts($('div#speedTestAlerts div#infoAlerts'), "<i class='fa fa-spinner fa-spin'></i>", 'show');
            if (connection == "wireless") {
                wirelessSpeedTestConfiguration();
            } else {
                runEthernetSpeedTest();
