...
class PiwikTracker
{
    ...
    public $storedTrackingActions = array();
     ...
     * @return  PiwikTracker
     */
    public function set_apiUrl($url)
    {
        $this->apiUrl = $url;
        self::$URL = (string) $url;
        return $this;
     ...
     * @return  PiwikTracker
     */
    public function set_idSite($val)
    {
        $this->idSite = $val;
        return $this;
    }
