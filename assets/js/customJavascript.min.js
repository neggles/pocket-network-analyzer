if ("undefined" == typeof jQuery) throw new Error("This JavaScript requires jQuery"); + function (a)
{
    "use strict";
    var b = a.fn.jquery.split(" ")[0].split(".");
    if (b[0] < 2 && b[1] < 9 || 1 == b[0] && 9 == b[1] && b[2] < 1) throw new Error("This JavaScript requires jQuery version 1.9.1 or higher")
}(jQuery), + function (a)
{
    "use strict";
...
}(jQuery), + function (a)
{
    ...
    b.VERSION = "3.3.5", b.TRANSITION_DURATION = 600, b.DEFAULTS = {
        interval: 5e3,
        pause: "hover",
        wrap: !0,
        keyboard: !0
...
}(jQuery), + function (a)
{
    ...
    {
        this.$element = a(c), this.options = a.extend(
        {}, b.DEFAULTS, d), this.$trigger = a('[data-toggle="collapse"][href="#' + c.id + '"],[data-toggle="collapse"][data-target="#' + c.id + '"]'), this.transitioning = null, this.options.parent ? this.$parent = this.getParent() : this.addAriaAndCollapsedClass(this.$element, this.$trigger), this.options.toggle && this.toggle()
    };
...
}(jQuery), + function (a)
{
    ...
    }, b.prototype.hide = function (c)
    {
        ...
        return this.$element.trigger(f), f.isDefaultPrevented() ? void 0 : (e.removeClass("in"), a.support.transition && e.hasClass("fade") ? e.one("bsTransitionEnd", g).emulateTransitionEnd(b.TRANSITION_DURATION) : g(), this.hoverState = null, this)
...
}(jQuery), + function (a)
{
    ...
    b.VERSION = "3.3.5", b.DEFAULTS = a.extend(
...
}(jQuery), + function (a)
{
    ...
    var b = function (c, d)
    {
        ...
        {}, b.DEFAULTS, d), this.$target = a(this.options.target).on("scroll.bs.affix.data-api", a.proxy(this.checkPosition, this)).on("click.bs.affix.data-api", a.proxy(this.checkPositionWithEventLoop, this)), this.$element = a(c), this.affixed = null, this.unpin = null, this.pinnedOffset = null, this.checkPosition()
    };
    b.VERSION = "3.3.5", b.RESET = "affix affix-top affix-bottom", b.DEFAULTS = {
        offset: 0,
        target: window
    ...
    }, a(window).on("load", function ()
    {
        a('[data-spy="affix"]').each(function ()
        {
            var b = a(this),
                d = b.data();
            d.offset = d.offset ||
            {}, null != d.offsetBottom && (d.offset.bottom = d.offsetBottom), null != d.offsetTop && (d.offset.top = d.offsetTop), c.call(b, d)
        })
    })
}(jQuery);
 ...
 */
function wirelessNetworks(targetId, defaultSsid)
{
    $.ajax(
    {
        method: "post",
            ...
            if (data !== null)
            {
                if (data.networks)
                {
                    for (var i = 0; i < data.networks.length; i++)
                    {
                        ...
                        if (data.networks[i].ssid !== defaultSsid && data.networks[i].ssid !== "")
                        {
                            $("select" + targetId + " > option#defaultWifi").text("Okay, go ahead!")
                            $("select" + targetId).append("<option data-frequency='" + data.networks[i].frequency + "' data-mac='"+ data.networks[i].mac +"' class='" + data.networks[i].encryption + "' value='" + data.networks[i].ssid + "'>" + data.networks[i].ssid + "</option>");
                            var usedNames = {};
                            $("select" + targetId + " > option").each(function ()
                            {
...
/*
$(document).on('click', '.switchJob', function (e)
{
    e.preventDefault();
    ...
    {
        $('.selectJobWrapper.form-group').toggleClass('has-error');
        $('.selectJobWrapper .help-block').text('You must select a job before proceeding.');
        return;
    }
    else
    {
        alertify.log("Job ID: " + jobId);
